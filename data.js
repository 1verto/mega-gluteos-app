const routinesData = [
  ...
  },
  {
    ...
    content: `
      ...
      <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 1rem; border-radius: 4px; margin-top: 1.5rem;">
        <strong><i class="fas fa-exclamation-triangle"></i> ¡Atención para mañana!</strong><br>
        Mañana inicia la <strong>Fase de Fuerza Máxima</strong>. Necesitarás tu <strong>Banda de Resistencia</strong> y <strong>mucho peso (mancuernas pesadas o una mochila bien cargada)</strong>.
      </div>
    `
  },
  {
    ...
    content: `
      ...
      <div class="interactive-form">
        ...
        <label class="checkbox-container">
          ...
          <div class="checkbox-text">
            ...
            <img src="./ref-sideraise-band.png" class="mini-ref-img" style="margin-top:0.5rem;" alt="Elevación Lateral">
      ...
      <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 1rem; border-radius: 4px; margin-top: 1.5rem;">
        <strong><i class="fas fa-exclamation-triangle"></i> ¡Atención para mañana!</strong><br>
        Mañana haremos Entrenamiento Funcional y Cardio. Prepara tu <strong>Cronómetro</strong> y tu <strong>Peso extra (mancuernas/botellas)</strong> para los step-ups.
      </div>
    `
  },
  {
